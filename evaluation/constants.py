...
COCO30K_PATH = os.getenv("COCO30K_PATH", f"{EVAL_BASE}/dataset/COCO/COCO30k.json")
COCO6K_PATH = os.getenv("COCO6K_PATH", f"{EVAL_BASE}/dataset/COCO/COCO6k.json")
COCO3K_PATH = os.getenv("COCO3K_PATH", f"{EVAL_BASE}/dataset/COCO/COCO3k.json")
...
FID_INCEPTION_PATH = os.getenv("FID_INCEPTION_PATH", f"{EVAL_BASE}/FID/pt_inception-2015-12-05-6726825d.pth")
FID_TARGET_PATH = {
    "coco30k": os.getenv("FID_TARGET_COCO30K", f"{EVAL_BASE}/FID/coco_val_fid_stats.pt"),
    "coco6k": os.getenv("FID_TARGET_COCO6K", f"{EVAL_BASE}/FID/coco_val_fid_stats.pt"),
    "coco3k": os.getenv("FID_TARGET_COCO3K", f"{EVAL_BASE}/FID/coco_val_fid_stats.pt"),
}
CLIP_MODEL_PATH = os.getenv("CLIP_MODEL_PATH", f"{EVAL_BASE}/CLIP/ViT-B-32.pt")
HPSV2_MODEL_PATH = os.getenv("HPSV2_MODEL_PATH", f"{EVAL_BASE}/xswu-HPSv2/HPS_v2.1_compressed.pt")
