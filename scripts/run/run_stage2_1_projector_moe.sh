...
# Stage 2.1: Projector Warmup (MoE Baseline)
...
export CKPT_DIR="${CKPT_DIR:-outputs/stage1_lm_moe/ckpt/0035000}"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/stage2_1_projector_moe}"
...
bash launch/workers/run_train.sh torchrun \
    train/configs/stage2_1_projector_moe.yaml \
    --ckpt-dir "${CKPT_DIR}" \
