...
# Stage 2.2: Full MMU Training (MoE Baseline)
...
export CKPT_DIR="${CKPT_DIR:-outputs/stage2_1_projector_moe/ckpt/0003000}"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/stage2_2_mmu_moe}"
...
bash launch/workers/run_train.sh torchrun \
    train/configs/stage2_2_mmu_moe.yaml \
    --ckpt-dir "${CKPT_DIR}" \
